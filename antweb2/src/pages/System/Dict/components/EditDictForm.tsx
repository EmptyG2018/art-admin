...
interface EditDictForm extends EditDictWrapperForm {
  trigger: JSX.Element;
  title: string;
}

const EditDictWrapperForm: React.FC<EditDictWrapperForm> = (props) => {
...
const EditDictForm: React.FC<EditDictForm> = (props) => {
