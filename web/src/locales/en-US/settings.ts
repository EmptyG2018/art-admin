export default {
  ...
  'settings.security.form.confirmpassword': 'Confirm Password',
  'settings.security.form.confirmpassword.placeholder':
    'Please enter the password again',
  'settings.security.form.confirmpassword.rule':
    'The two passwords do not match!',
  'settings.appearance.style': 'Overall Style',
  'settings.appearance.style.light': 'Light',
  'settings.appearance.style.dark': 'Dark',
  'settings.appearance.primary': 'Primary Color',
  'settings.form.updateSubmit': 'Update Profile',
};
