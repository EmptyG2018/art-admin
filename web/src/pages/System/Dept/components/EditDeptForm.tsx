...
interface EditDeptForm extends EditDeptWrapperForm {
  trigger: JSX.Element;
  title: string;
}

const EditDeptWrapperForm: React.FC<EditDeptWrapperForm> = (props) => {
...
const EditDeptForm: React.FC<EditDeptForm> = (props) => {
